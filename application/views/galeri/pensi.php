...
<body>
   ...
   <section class="popular-location galerikegiatan2">
    <div class="container center">
        <span class="teal-text">Kegiatan</span>
        <h2>Membatik Bersama</h2>
    </div>
      ...
      <div class="container" style="width:80%">
        <div class="row box">
            <div class="col s12 m12">
                <div class="wrapper">
                    <div class="gallery">
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/pensi1.png') ?>" alt=""></span></div>
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/pensi2.png') ?>" alt=""></span></div>
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/pensi3.png') ?>" alt=""></span></div>
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/pensi4.png') ?>" alt=""></span></div>
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/pensi5.png') ?>" alt=""></span></div>
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/pensi6.png') ?>" alt=""></span></div>
                  ...
                  <div class="preview-box">
                    ...
                    <div class="image-box">
                      <div class="slide prev"><i class="small material-icons ">arrow_back</i></div>
                      <div class="slide next"><i class="small material-icons ">arrow_forward</i></div>
                      <img src="" alt="">
                    </div>
                  </div>
