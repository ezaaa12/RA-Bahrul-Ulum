      ...
      <div class="container" style="width:80%">
        <div class="row box">
            <div class="col s12 m12">
                <div class="wrapper">
                    <div class="gallery">
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/porsenisenam1.png') ?>" alt=""></span></div>
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/porsenisenam2.jpg') ?>" alt=""></span></div>
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/porsenisenam3.jpg') ?>" alt=""></span></div>
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/porseniwarna1.jpg') ?>" alt=""></span></div>
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/porseniwarna1.jpg') ?>" alt=""></span></div>
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/porseniwarna2.jpg') ?>" alt=""></span></div>
                    </div>
                  </div>
