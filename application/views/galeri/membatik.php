      ...
      <div class="container" style="width:80%">
        <div class="row box">
            <div class="col s12 m12">
                <div class="wrapper">
                    <div class="gallery">
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/membatik1.jpg') ?>" alt=""></span></div>
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/membatik2.jpg') ?>" alt=""></span></div>
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/membatik4.jpg') ?>" alt=""></span></div>
