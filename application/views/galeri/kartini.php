      ...
      <div class="container" style="width:80%">
        <div class="row box">
            <div class="col s12 m12">
                <div class="wrapper">
                    <div class="gallery">
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/kartini1.png') ?>" alt=""></span></div>
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/kartini2.png') ?>" alt=""></span></div>
                    <div class="image"><span><img src="<?= base_url('assets/img/galeri/kartini3.png') ?>" alt=""></span></div>
                    </div>
                  </div>
