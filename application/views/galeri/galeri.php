...
<body>
    ...
    <div class="popular-location galerikegiatan ">
        <div class="row galeribu center">
            <span class="teal-text">Galeri Kegiatan</span>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="single-location mb-30">
                        ...
                        <div class="location-details">
                            <p>Kegiatan Internal Sekolah</p>
                            <a href="<?= base_url('galeri/keginternal') ?>" class="location-btn teal white-text">Detail Kegiatan</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="single-location mb-30">
                        ...
                        <div class="location-details">
                            <p>Kegiatan Eksternal Sekolah</p>
                            <a href="<?= base_url('galeri/kegeksternal') ?>" class="location-btn teal white-text">Detail Kegiatan</a>
                        </div>
                    </div>
                </div>
            </div>
