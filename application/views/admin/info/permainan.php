...
<div class="container-fluid">
   ...
   <div class="row">
      ...
      <div class="col-sm-2">
         <a href="" class="btn btn-gradient mb-3" data-toggle="modal" data-target="#newMainanModal" style="background-color:#00bfa5; color:white; margin-top:1px;">Tambah Fasilitas</a>
      </div>
   </div>
      ...
      <?php foreach ($permainan as $p) : ?>
         <div class="col-sm-2">
            <div class="card" style="width: 10rem; text-align: center; margin-top:20px;">
               ...
               <div class="card-body">
                  <a href=" <?= base_url('admininfo/ubahpermainan/') . $p['id']; ?>" class=" btn btn-success"><i class="far fa-edit"></i></a>
                  <a href="<?= base_url('admininfo/hapuspermainan/') . $p['id']; ?>" class=" btn btn-danger" onclick="return confirm('hapus?')"><i class="far fa-trash-alt"></i></a>
               </div>
